...
namespace MantisSharp
{
  public class TagCollection : ICollection<Tag>
  {
    ...
    private readonly IList<Tag> _items;
    ...
    public bool TryGetValue(int key, out Tag value)
    {
      int index;
    ...
    #region ICollection<Tag> Interface
