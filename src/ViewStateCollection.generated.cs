...
{
  public class ViewStateCollection : IEnumerable<ViewState>
  {
    #region Constants

    private readonly IDictionary<string, int> _dictionary;

    private readonly IList<ViewState> _items;

    #endregion

    #region Constructors

    protected ViewStateCollection()
    {
      _dictionary = new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase);
      _items = new List<ViewState>();
    }
    ...
    public ViewState this[string key]
    {
      get
      {
        int index;
    ...
    public ViewState this[int index]
    {
    ...
    public void Add(ViewState item)
    {
      string name;
    ...
    public bool Remove(ViewState item)
    {
    ...
    public bool TryGetValue(string key, out ViewState value)
    {
      int index;
    ...
    #region IEnumerable<ViewState> Interface

    public IEnumerator<ViewState> GetEnumerator()
    {
