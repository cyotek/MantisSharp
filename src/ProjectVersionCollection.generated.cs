...
namespace MantisSharp
{
  public partial class ProjectVersionCollection : ICollection<ProjectVersion>
  {
    ...
    private readonly IList<ProjectVersion> _items;
    ...
    public ProjectVersionCollection()
    {
      ...
      _items = new List<ProjectVersion>();
    }
    ...
    public ProjectVersion this[string key]
    {
      get
      {
        int index;
    ...
    public ProjectVersion this[int key]
    {
      get
      {
        int index;
    ...
    public bool TryGetValue(string key, out ProjectVersion value)
    {
      int index;
    ...
    public bool TryGetValue(int key, out ProjectVersion value)
    {
      int index;
    ...
    #region ICollection<ProjectVersion> Interface

    public bool Contains(ProjectVersion item)
    {
      return this.ContainsKey(item.Id);
    }

    public void CopyTo(ProjectVersion[] array, int arrayIndex)
    {
      _items.CopyTo(array, arrayIndex);
    }

    public IEnumerator<ProjectVersion> GetEnumerator()
    {
    ...
    bool ICollection<ProjectVersion>.IsReadOnly
    {
      get { return false; }
    }
